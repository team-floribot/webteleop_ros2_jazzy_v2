...
function toggleConnection() {
    ...
    if (!isConnected) {
        ...
        const ip = useLocalhostCheckbox.checked
            ? location.hostname //"10.84.37.131"   IP ADRESSS FORM HOTSPOT              // IP from Local Hotspot → changed if needed
...
function startCmdLoop() {
    ...
    cmdTimer = setInterval(() => {
        ...
        batteryPercent = 1500; //Math.abs(desiredLinear) * 100 + 25; //Place holder
        updateStatusBar();
